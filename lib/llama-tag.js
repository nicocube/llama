...
module.exports = (function() {
    ...
    LlamaTag.prototype.clone = function(visitor) {
        var a = this.cloneArgs(this.a, visitor)
        var c = this.cloneChild(this.c, visitor)
        c.unshift(a)
        return new LlamaTag(this.t, c)
    }
    LlamaTag.prototype.cloneArgs = function(a, visitor) {
        return mlf(Object.keys(a)).reduce(function(r,k) {
            r[k] = visitor(a[k])
            return r
        }.bind(this), {})
    }
    LlamaTag.prototype.cloneChild = function(c, visitor) {
        return mlf(c).map(function(o) {
            ...
            if (typeof visitor === 'function') n = visitor(n)
            return n
        }.bind(this)).get()
    }
